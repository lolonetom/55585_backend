...
const test = async () => {
    const getProduct1 = await productManager.getProducts();
    console.log('los productos: ', getProduct1);
    /* await productManager.addProducts(prod1); */
    const getProduct2 = await productManager.getProducts();
    console.log('los productos: ', getProduct2);
}
